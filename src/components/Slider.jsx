...
const Slider = ({ isOpen, onClose }) => {
  ...
  {
    id: "harlow town cc",
    title: "Harlow Town CC",
    items: [
      "Manage Club",
      "Customise Club Website",
      "View Club Website",
      "Team Reports",
    ]
  },
                ...
                <div key={parent.id}>
                  ...
                  >
                    <div className="d-flex align-items-center">
                      ...
                      <span className="ml-2 slider-name text-white font-weight-bold">{parent.title}</span>
                    </div>
                  ...
                  {openParents.includes(parent.id) && (
                    <ul className="list-unstyled m-0 p-0">
                      {parent.items.map((item, index) => (
                        <li key={index} className="dropdown-item ml-4 text-white">
                          <span>- </span>
                          {item}
                        </li>
                      ))}
