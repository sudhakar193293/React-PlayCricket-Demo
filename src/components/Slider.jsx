  ...
  return (
    <>
      ...
      <div className={`${styles.slider} ${isOpen ? styles.open : ""}`} ref={sliderRef}>
        <div className={`${styles.mobile_top} d-lg-none`}>
          <div className={`${styles.logo_container}`}>
            <img src={pclogo} alt="logo" width="138px" height="29.96px"/>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={()=>{onClose()}} style={{cursor:'pointer'}}>
                  ...
                  <div key={parent.website.id}>
                    ...
                    >
                      <div className="d-flex align-items-center">
                        ...
                        <span className={`${styles.parentContent} text-white`}>{parent.website.name}</span>
                        <span className={`slider-arrow ${open ? "open" : ""}`}>
                          <svg width="20" height="20"  className={`arrow ${(openParents.includes(parent.website.id)) ? 'rotate' : ''}`}  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className={`${styles.accord} pt-3`}>
          ...
          >
            <div className="d-flex align-items-center">
              ...
              <span className={`${styles.parentContent} text-white`}>{data?.user?.userName}</span>
              <span className={`slider-arrow ${open ? "open" : ""}`}>
                <svg width="20" height="20"  className={`arrow ${(openParents.includes(data?.user?.id)) ? 'rotate' : ''}`}  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6.79492 18.885L13.5938 12L6.79492 5.115L8.88804 3L17.7949 12L8.88804 21L6.79492 18.885Z" fill="#FFFFFF"/>
                </svg>
              </span>
            </div>
          ...
          {data?.user?.childUsers?.map((childParent)=>(
            <div key={childParent.id}>
              ...
              {/* Dropdown Header */}
              <div
                className={`${styles.parentContainer} ${openParents.includes(childParent.id)? styles.selectedParent:''}`}
              ...
              >
                <div className="d-flex align-items-center">
                  ...
                  <span className={`${styles.parentContent} text-white`}>{childParent.userName}</span>
                </div>
                <span className={`slider-arrow ${open ? "open" : ""}`}>
                  <svg width="20" height="20"  className={`arrow ${(openParents.includes(childParent.id)) ? 'rotate' : ''}`}  viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M6.79492 18.885L13.5938 12L6.79492 5.115L8.88804 3L17.7949 12L8.88804 21L6.79492 18.885Z" fill="#FFFFFF"/>
                  </svg>
                </span>
              </div>
