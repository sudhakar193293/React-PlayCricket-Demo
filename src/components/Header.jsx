        ...
        <ul className={`navbar-nav ${styles["header-links"]} ${styles.headerNav}`}>
                ...
                {!(permissions?.day_to_day?.fixtures === false && permissions?.day_to_day?.find_a === false && permissions?.setup?.scoring_rules === false) &&
                  <li>
                    ...
                    <ul className='list-unstyled m-0 p-0'>
                      {permissions?.day_to_day?.fixtures &&<li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/matches`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Fixture management</a></li>}
                      {permissions?.day_to_day?.fixtures &&<li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/repeat_fixtures`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Repeat fixtures</a></li>}
                      {permissions?.day_to_day?.find_a && <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/fixture_bureau`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Find a fixture</a></li>}
                      {permissions?.day_to_day?.find_a && <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/ground_availabilities`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Find a ground</a></li>}
                      {permissions?.setup?.scoring_rules && <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/club_scoring_rules`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Scoring rules</a></li>}
                    </ul>
                    )}
                  </li>
                }
              ...
              <li>
                ...
                <ul className='list-unstyled m-0 p-0'>
                  {permissions?.site_management?.about_us && 
                    <>
                    <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/about_us/club_details`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Club details</a></li>
                    <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/about_us/playing_facilities`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Playing facilities</a></li>
                    </>
                  }
                  {permissions?.site_management?.information_board && <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/document_library/articles/index`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Documents</a></li>}
                </ul>
                )}
              </li>
              <li>
                ...
                <ul className='list-unstyled m-0 p-0'>
                  ...
                  {permissions?.setup?.privacy_notices &&
                    <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/privacy_notices`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Privacy notices</a></li>
                  } 
                  {permissions?.site_management?.gallery &&
                    <>
                      <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/photos`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Photo gallery</a></li>
                      <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/videos`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Video gallery</a></li>
                    </>
                  }                    
                </ul>
                )}
              ...
              <li>
                ...
                <ul className='list-unstyled m-0 p-0'>
                  {permissions?.site_management?.information_board &&
                    <>
                      <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/news_articles/news_articles/index`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>News</a></li>
                      <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/posts`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Members board</a></li>
                      <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/member_forums`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Members forum</a></li>                   
                      <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/calendar`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Calendar</a></li>
                    </>
                  }
                </ul>
                )}
              ...
              <li>
                ...
                <ul className='list-unstyled m-0 p-0'>
                  {permissions?.site_management?.website_configuration &&
                    <>
                      <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/website_configurations/home_page`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Homepage</a></li>
                      <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/website_configurations/docs_config`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Documents</a></li>
                      <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/website_configurations/fixtures`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Fixture & results</a></li>
                      <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/menu_configs`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Menu</a></li>
                      <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/custom_pages`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Page builder</a></li>
                      <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/website_configurations/statistics`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Statistics</a></li>
                    </>
                  }
                  {permissions?.upload?.badge &&
                    <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/website_configurations/badge`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Badge</a></li>
                  }
                </ul>
                )}
              </li>
          ...
          <li className={`nav-item text-nowrap dropdown ${styles.hactive} ${openmenu === 'people' ? `show ${styles.active}` : ''}`}>
            ...
            <ul className={`dropdown-menu ${openmenu === 'people' ? 'show' : ''}`} aria-labelledby="navbarDropdown">
              {permissions?.site_management?.about_us &&
              <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/about_us/officials`,data?.website?.subdomain)}>Club Officials</a></li>
              }
              <li>
                ...
                <ul className='list-unstyled m-0 p-0'>
                  ...
                  {permissions?.setup?.administrator_roles &&
                    <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/administrator_roles`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Administration roles</a></li>
                  }
                  {permissions?.setup?.messaging_groups && 
                    <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/messaging_groups`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Messaging groups</a></li>
                  }
                  {permissions?.upload?.members_upload &&
                    <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/member_uploads`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Members upload</a></li>
                  }
                </ul>
                )}
              </li>
          ...
          <li className={`nav-item text-nowrap dropdown ${styles.hactive} ${openmenu === 'competitions' ? `show ${styles.active}` : ''}`}>
            ...
            <ul className={`dropdown-menu ${openmenu === 'competitions' ? 'show' : ''}`} aria-labelledby="navbarDropdown">
              <li>
                ...
                <ul className='list-unstyled m-0 p-0'>
                  <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/player_nominations`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Player nominations</a></li>
                  <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/player_nomination_statuses`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Objections to nominations</a></li>
                  <li><a className='dropdown-item text-dark text-decoration-none' onClick={()=>handleLinkClick(`https://annatest.${BASE_HOST}/site_admin/club_player_suspensions`,data?.website?.subdomain)}><span className={`${styles.hyphen}`}>&mdash;&nbsp;&nbsp;</span>Suspensions</a></li>
                </ul>
                )}
              </li>
